...
export default class About extends Vue {
  ...
  mounted() {
    ...
    for (let i = 0; i < nodes.length; ++i) {
      ...
      if (typeof nodes[i].next !== 'undefined' && nodes[i].next !== 'None') {
